...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JHMicroservicesGatewayApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JHMicroservicesGatewayApplication");
        ...
        config.getMapConfigs().put("io.github.juliandresbv.jhipster.mg.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
